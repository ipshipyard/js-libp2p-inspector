...
import { LIBP2P_INSPECTOR_METRICS_KEY, inspectorMetrics } from '../src/index.js'
import type { ComponentLogger, ContentRouting, Libp2pEvents, Metrics, NodeInfo, PeerId, PeerRouting, PeerStore } from '@libp2p/interface'
...
*/
  ...
  it('should signal presence of metrics', () => {
    expect(globalThis).to.have.property(LIBP2P_INSPECTOR_METRICS_KEY).that.is.true()
  })
})
